...
const Navbar = ({ children }) => {
    ...
    return (
        <div data-theme={dark ? "dark" : "light"} className="drawer drawer-end mt-16">
            <input id="my-drawer-3" type="checkbox" className="drawer-toggle" />
            <div className="drawer-content flex flex-col">

                <div className="w-full navbar top-0 fixed z-50 bg-base-100 lg:px-10">
                    ...
                    <div className="flex-1 px-2 mx-2 text-2xl font-bold text-fuchsia-700"> Clean Co </div>
                ...
                <ul className="menu p-4 overflow-y-auto w-80 bg-base-100">
                    ...
                    <div tabindex="0" class="collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
                        ...
                        <div class="collapse-content">
                            ...
                            <li><NavLink to="/login" className='rounded-lg'> PreBook </NavLink></li>
                        </div>
                    </div>
